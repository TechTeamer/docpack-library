...
\begin{document}
  ...
  \markdownInput{output/text_segment_0.md}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{images/lisan al gaib}
    \caption{Lisa al gaib}
    \label{fig:lisa}
  \end{figure}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=\linewidth]{images/asd}
    \caption{Mermaid}
    \label{fig:mermaid}
  \end{figure}
